...
-s: int: line number in file were (sub)strucure is stored, starting with 0 for the first line.

-m: n shows the substructures
-m: y shows the substructures highlighted having the substructure as background
-m: a if a substructure can match the structure on several locations, all possiblities are shown
