...
environmental method and then filters the substructures based on mol weight, 
...
Command line: python3 environmental_substructure_generation.py -i [input file] -m [minimum mol weight] -h [nr of hetero atoms] -r [nr of rings] -a [abundancy] -b [nr of bonds]
@author: stokm006
"""
